...
Move findMove(std::string move_chosed) {
	...
	while(!valid_move) {
		...
		if(it != movedex.end()) {
			...
			std::cout << "Nombre de Pokemon no v疝ido" << std::endl
...
int getPriority(std::string move_chosed) {
	...
	if(it != movedex.end())
		...
		std::cout << "Nombre del Movimiento no v疝ido" << std::endl;
		return 0;
	}
}

/******************MOVEDEX******************/
/*En esta secci se alamacenar疣 a todos los Movimientos
 */
std::vector<Move> movedex {
	...
	Move {	// Movimiento producto de la autolesi por confusi
		"Autolesion",	// Nombre
		"None",	// Tipo
		"Fisico",	// Clase
		40,	// Potencia
	...
	Move {	// Se activa con la habilidad de Carga Tica
		"Carga Toxica+",	// Nombre
		"Veneno",	// Tipo
		"Especial",	// Clase
		130,	// Potencia
	...
	Move {	// Este movimiento es 佖ico en cuanto efecto, as・que no tomar como referencia para otros movimientos
		"Doble Ataque",	// Nombre
		"Bicho",	// Tipo
		"Fisico",	// Clase
		25,	// Potencia
	...
	Move {	// tiene un trato especial programado en las funciones ejecuteMove y receiveMove
		...
		"Normal",	// Tipo
		"Fisico",	// Clase
		1,	// Potencia	// Necesito hacerlo as・par aque el cigo funcione
		100,	// Precisi
		1,	// Objetivo enemigo
		0,	// Prioridad
		0,	// Cr咜ico
	...
	Move {
		...
		"Lucha",	// Tipo
		"Fisico",	// Clase
		1,	// Potencia	// Este valor es 1 para ayudar al cigo
		100,	// Precisi
		1,	// Objetivo enemigo
		0,	// Prioridad
		0,	// Cr咜ico
	...
	Move {	// Este movimiento es la versi de Persecuci cuando es utilizada durante el cambio del enemigo
		"Persecucion+",	// Nombre
		"Siniestro",	// Tipo
		"Fisico",	// Clase
		80,	// Potencia
